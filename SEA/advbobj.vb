...
Public Class advbobj
    ...
    Dim dataadapt As New SqlDataAdapter("select * from dbtest.advbobj", con)
    ...
    Private Sub advbobj_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            quer = "select Timer from advbobj"
    ...
    Private Sub question()
        ...
        Try
            ...
            cmd.CommandText = "SELECT  Question, A, B, C, D, Answer FROM advbobj"
            cmd.Connection = con
    ...
    Private Sub mark()
        Try
            Do
                ...
                con.Open()
                cmd.CommandText = "SELECT  Answer FROM advbobj WHERE Answer IS NOT NULL"
                cmd.Connection = con
                datareader = cmd.ExecuteReader
                If datareader.HasRows Then
                    datareader.Read()
    ...
    Private Sub BunifuThinButton24_Click(sender As Object, e As EventArgs) Handles nextrecord.Click
        ...
        Try
            con.Open()
            Dim query As String
            query = "UPDATE advbobj SET score = '" & score + 1 & "' WHERE score IS NOT NULL "
            cmd.Connection = con
