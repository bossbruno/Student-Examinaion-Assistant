...
Public Class advbexams
    ...
    Private Sub advbexams_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            quer = "select Timer from advancedvb"
    ...
    Private Sub BunifuThinButton22_Click_1(sender As Object, e As EventArgs) Handles BunifuThinButton22.Click
        ...
        Try
            ...
            Dim query As String
            query = "insert into advbanswers (idStudent,Answer,Qno) values ('" & id.Text & "','" & TextBox1.Text & "', '" & lblQnu.Text & "' ) "
