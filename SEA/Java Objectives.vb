...
Public Class Java_Objectives
    ...
    Private Sub Java_Objectives_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            quer = "select Timer from javaobjectives"
    ...
    Private Sub question()
        ...
        Try
            ...
            cmd.CommandText = "SELECT Qnumber, Question, A, B, C, D, Answer FROM javaobjectives"
            cmd.Connection = con
    ...
    Private Sub mark()
        Try
            Do
                ...
                con.Open()
                cmd.CommandText = "SELECT  Answer FROM javaobjectives WHERE Answer IS NOT NULL"
                cmd.Connection = con
                datareader = cmd.ExecuteReader
                If datareader.HasRows Then
                    datareader.Read()
    ...
    Private Sub BunifuThinButton24_Click(sender As Object, e As EventArgs)
        Try
            con.Open()
            Dim query As String
            query = "UPDATE javaobjectives SET score = '" & score & "' WHERE score IS NOT NULL "
            cmd.Connection = con
    ...
    Private Sub BunifuThinButton22_Click_1(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim query As String
            query = "update Student set idStudent='" & it.Text & "', StudentPassword='" & Label7.Text & "', StudentScore='" & Label5.Text & "' where idStudent='" & it.Text & "'"
    ...
    Private Sub BunifuThinButton22_Click_2(sender As Object, e As EventArgs) Handles BunifuThinButton22.Click
        ...
        MySqlConn.ConnectionString = "Data Source=DESKTOP-JP78HRE\SQLEXPRESS;Initial Catalog=dbtest;Integrated Security=Truet"
        ...
        Try
            ...
            Dim query As String
            query = "update Student set StudentPassword='" & Label7.Text & "',
           StudentScoreA='" & Label5.Text & "' where idStudent='" & it.Text & "'"
            Command = New SqlCommand(query, MySqlConn)
            Reader = Command.ExecuteReader
            'StudentPassword='" & Label7.Text & "',
    ...
    Private Sub firstrecord_Click_1(sender As Object, e As EventArgs) Handles firstrecord.Click
        cm.Position = 0
        showpositions()

    End Sub

    Private Sub nextrecord_Click_1(sender As Object, e As EventArgs) Handles nextrecord.Click
    ...
    Private Sub lastrecord_Click_1(sender As Object, e As EventArgs) Handles lastrecord.Click
    ...
    Private Sub previouserecord_Click_1(sender As Object, e As EventArgs) Handles previouserecord.Click
        cm.Position = cm.Position - 1
        showpositions()
    End Sub
