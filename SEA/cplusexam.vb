...
Public Class cplusexam
    ...
    Private Sub cplusexam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BunifuThinButton22_Click_1(sender As Object, e As EventArgs) Handles BunifuThinButton22.Click
        ...
        Try
            ...
            Dim query As String
            query = "insert into cplusanswers (idStudent,Answer,Qno) values ('" & id.Text & "','" & TextBox1.Text & "', '" & lblQnu.Text & "' ) "
    ...
    Private Sub BunifuThinButton23_Click_1(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim query As String
            query = "update dbtest.Student set idStudent='" & id.Text & "', StudentPassword='" & Label5.Text & "',  where idStudent='" & id.Text & "'"
            Command = New SqlCommand(query, MySqlConn)
            Reader = Command.ExecuteReader
