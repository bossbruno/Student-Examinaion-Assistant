...
Public Class adjavaobj
    ...
    Private Sub adjavaobj_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            quer = "select Timer from adjavaobj"
    ...
    Private Sub question()
        ...
        Try
            ...
            cmd.CommandText = "SELECT  Question, A, B, C, D, Answer FROM adjavaobj"
            cmd.Connection = con
    ...
    Private Sub mark()
        Try
            Do
                ...
                con.Open()
                cmd.CommandText = "SELECT  Answer FROM adjavaobj WHERE Answer IS NOT NULL"
                cmd.Connection = con
                datareader = cmd.ExecuteReader
                If datareader.HasRows Then
                    datareader.Read()
    ...
    Private Sub BunifuThinButton24_Click(sender As Object, e As EventArgs) Handles nextrecord.Click
        Try
            con.Open()
            Dim query As String
            query = "UPDATE adjavaobj SET score = '" & score + 1 & "' WHERE score IS NOT NULL "
            cmd.Connection = con
    ...
    Private Sub BunifuThinButton22_Click_1(sender As Object, e As EventArgs) Handles BunifuThinButton22.Click
        ...
        Try
            ...
            Dim query As String
            query = "update Student set StudentPassword='" & Label7.Text & "', StudentScoreA='" & Label5.Text & "' where idStudent='" & it.Text & "'"
