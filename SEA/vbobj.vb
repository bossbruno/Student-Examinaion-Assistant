...
Public Class vbobj
    ...
    Private Sub vbobj_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub question()
        ...
        Try
            ...
            cmd.CommandText = "SELECT  Question, A, B, C, D, Answer FROM vbobj"
            cmd.Connection = con
    ...
    Private Sub mark()
        Try
            Do
                ...
                con.Open()
                cmd.CommandText = "SELECT  Answer FROM vbobj WHERE Answer IS NOT NULL"
                cmd.Connection = con
                datareader = cmd.ExecuteReader
                If datareader.HasRows Then
                    datareader.Read()
    ...
    Public Sub bindfieldss()
        ...
        Label2.DataBindings.Add("text", dv, "Timer")
    ...
    Private Sub BunifuThinButton24_Click(sender As Object, e As EventArgs) Handles nextrecord.Click
        ...
        Try
            con.Open()
            Dim query As String
            query = "UPDATE vbobj set score = '" & score + 1 & "' WHERE score IS NOT NULL "
            cmd.Connection = con
